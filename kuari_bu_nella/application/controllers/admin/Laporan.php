...

{
    ...
    public function lapMaterial()
    {
        ...
        $this->load->view('admin/lap_trx_material_param', $data);
    }
    ...
    public function lapMaterial_view()
    {
        ...
        // $data['menus'] = $this->Menu_model->get_all();
        $this->load->view('admin/lap_trx_material_view', $data);
    }
    ...
    public function lapMaterialperSopir()
    {
        ...
        $this->load->view('admin/lap_trx_material_persopir_param', $data);
    }
    ...
    public function lapMaterialperSopir_view()
    {
        ...
        // $data['menus'] = $this->Menu_model->get_all();
        $this->load->view('admin/lap_trx_material_persopir_view', $data);
    }
    ...
    public function lap_uang_masuk()
    {
        ...
        $this->load->view('admin/lap_trx_uangmasuk_param', $data);
    }
    ...
    public function lap_uang_masuk_view()
    {
        ...
        $this->load->view('admin/lap_trx_uangmasuk_view', $data);
    }
    ...
    public function lap_uang_keluar()
    {
        ...
        // $data['materials'] = $this->M_material->getAllMaterials();
        $this->load->view('admin/lap_trx_uangkeluar_param', $data);
    }
    ...
    public function lap_uang_keluar_view()
    {
        ...
        // $data['menus'] = $this->Menu_model->get_all();
        $this->load->view('admin/lap_trx_uangkeluar_view', $data);
    }
    ...
    {
        $this->load->view('admin/lap_resume_harian_param');
    }
    ...
    public function harian_view()
    {
        ...
        $this->load->view('admin/lap_resume_harian_view', $data);
    }
}
