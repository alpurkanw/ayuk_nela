...
class Material extends MY_Admin_Controller
{
    ...
    public function index()
    {
        ...
        // echo "tes";
        // return;
        $this->load->view('owner/master_material', $data); // Asumsikan nama view-nya adalah master_material.php
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('owner/material'); // Sesuaikan dengan URL controller
        } else {
