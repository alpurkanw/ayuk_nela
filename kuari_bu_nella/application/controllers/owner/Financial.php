...
class Financial extends MY_Admin_Controller
{
    ...
    //     $this->load->view('owner/master_account');
    // }
    ...
    public function uangMasuk()
    {
        ...
        $this->load->view('owner/trx_uang_masuk', $data);
    }
    ...
    public function prosesUangMasuk()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('owner/trx_uang_masuk'); // atau view yang sesuai
        } else {
            ...
            if ($is_success) {
                ...
                redirect('owner/financial/uangMasuk');
            } else {
    ...
    public function prosesUangKeluar()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('owner/trx_uang_keluar');
        } else {
            ...
            if ($is_success) {
                ...
                redirect('owner/financial/uangKeluar');
            } else {
