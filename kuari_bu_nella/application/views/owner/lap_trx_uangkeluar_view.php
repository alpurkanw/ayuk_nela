...
<body>
        ...
        <div class="card m-2 shadow-sm mb-4">
            <div class="card-body">
                ...
                <div class="mb-3 d-flex justify-content-end gap-2">
                    <a href="<?= base_url('owner/Laporan/lap_uang_keluar') ?>" class="btn btn-secondary" rel="noopener noreferrer">Kembali</a>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="laporanPenjualanKeluar">
                                ...
                                <?php if (!empty($trx_mtrls)) : ?>
                                    <tfoot class="table-light">
                                        <tr>
                                            <th colspan="3" class="text-end">GRAND TOTAL PENGELUARAN</th>
    ...
    <script>
        ...
        function exportExcel() {
            ...
            // Contoh: window.location.href = '<?= base_url('owner/laporan/exportPenjualanKeluarExcel'); ?>' + window.location.search;
        }
