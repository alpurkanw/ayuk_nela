...
<body>
    ...
    <div id="content m-2">
        ...
        <div class="card m-2 shadow-sm mb-4">
            <div class="card-body">
                <h5 class="card-title mb-2">Laporan Transaksi Uang Masuk</h5>
                <p class="card-text text-muted mb-4">Menampilkan rekapitulasi Transaksi Uang Masuk berdasarkan periode waktu.</p>
                <hr class="my-3">

                <div class="mb-3 d-flex justify-content-end gap-2">
                    <a href="<?= base_url('owner/Laporan/lap_uang_Masuk') ?>" class="btn btn-secondary" rel="noopener noreferrer">Kembali</a>
    ...
    <script>
        ...
        function exportExcel() {
            ...
            // Contoh: window.location.href = '<?= base_url('owner/laporan/exportPenjualanMasukExcel'); ?>' + window.location.search;
        }
        ...
        $(document).ready(function() {
            // Inisialisasi Select2 untuk filter Masuk (jika Masuk banyak)
            $('#MasukFilter').select2({
