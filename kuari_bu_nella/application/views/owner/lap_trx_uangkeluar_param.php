    ...
    <div id="content">
        ...
        <div class="card shadow-sm ">
            <div class="card-header bg-danger text-white">
                ...
                <p class="card-text ">
                    Menampilkan rekapitulasi transaksi uang Keluar berdasarkan periode waktu dan jenis kategori.</p>
            </div>
            <div class="card-body">

                <form action="<?= base_url('owner/Laporan/lap_uang_keluar_view'); ?>" method="post" class="">
