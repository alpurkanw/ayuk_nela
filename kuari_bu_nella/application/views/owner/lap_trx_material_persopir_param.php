...
<body>
    ...
    <div id="content m-2">
        ...
        <div class="card m-2 shadow-sm mb-4">
            <div class="card-header bg-success text-white">
                ...
                <p class="card-text  mb-4">Menampilkan rekapitulasi penjualan material berdasarkan periode waktu Dan Sopir tertentu</p>

            </div>
            <div class="card-body">

                <form action="<?= base_url('owner/Laporan/lapMaterialperSopir_view'); ?>" method="post" class="mb-4">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-4 col-lg-3">
                            <label for="materialFilter" class="form-label">Filter Sopir (Opsional)</label>
                            <select class="form-select" id="materialFilter" name="id_sopir">
                        ...
                        <div class="col-md-12 col-lg-3 d-flex justify-content-lg-end">
                            ...
                            <!-- <a href="<?= base_url('owner/laporan/penjualanMaterial'); ?>" class="btn btn-outline-secondary"><i class="bi bi-arrow-counterclockwise me-2"></i> Reset</a> -->
                        </div>
                    </div>
                </form>
    ...
    <script>
        ...
        function exportExcel() {
            ...
            // Contoh: window.location.href = '<?= base_url('owner/laporan/exportPenjualanMaterialExcel'); ?>' + window.location.search;
        }
