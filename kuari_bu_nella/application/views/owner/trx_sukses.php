            ...
            <div class="card shadow-sm border-success">
                <div class="card-body text-center">
                    ...
                    <div class="d-grid gap-2">
                        <a href="<?= base_url('owner/financial/uangMasuk'); ?>" class="btn btn-outline-primary btn-lg">
                            <i class="bi bi-plus-circle me-2"></i> Input Transaksi Lain
                        </a>
                        <a href="<?= base_url('owner/laporan/uangMasuk'); ?>" class="btn btn-outline-info">
                            <i class="bi bi-journal-text me-2"></i> Lihat Laporan Uang Masuk
                        </a>
                        <a href="<?= base_url('owner/dashboard'); ?>" class="btn btn-outline-secondary">
