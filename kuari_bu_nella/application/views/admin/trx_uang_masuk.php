    ...
    <div id="content">
        ...
        <div class="container">
            <div class="card ">
                ...
                <div class="card-body">
                    <form action="<?= base_url('admin/financial/prosesUangMasuk'); ?>" method="post" id="formUangMasuk">
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-info w-100">Simpan Uang Masuk</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#formUangMasuk').on('submit', function() {
                ...
                jumlahUang = jumlahUang.replace(/,/g, '');
                $('#jumlahUangMasuk').val(jumlahUang);
            });
