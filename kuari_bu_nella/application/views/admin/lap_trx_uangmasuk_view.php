...
<body>
        ...
        <div class="card m-2 shadow-sm mb-4">
            <div class="card-body">
                ...
                <div class="mb-3 d-flex justify-content-end gap-2">
                    <a href="<?= base_url('admin/Laporan/lap_uang_Masuk') ?>" class="btn btn-success" rel="noopener noreferrer">Kembali</a>
    ...
    <script>
        ...
        function exportExcel() {
            ...
            // Contoh: window.location.href = '<?= base_url('admin/laporan/exportPenjualanMasukExcel'); ?>' + window.location.search;
        }
