                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">LAPORAN HUTANG CUSTOMER PER PERUMAHAN</h6>
                        </div>
                        <div class="card-body p-4">
                            <?= $this->session->flashdata('pesan'); ?>
                            <form id="formDetailHarga" action="<?= base_url('owner/Claporan/lap_hutang_cust_view'); ?>" method="post">
