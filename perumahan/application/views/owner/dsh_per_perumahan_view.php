                        ...
                        <div class="col-lg-7 mb-4">
                            <div class="card shadow h-100">
                                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="<?= base_url('owner/Cdashboard/laporan_pengeluaran/' . $id_perum); ?>" class="btn btn-link btn-sm p-0 text-primary">Lihat semua</a>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary d-flex align-items-center justify-content-between">
                                ...
                                <a href="<?= base_url('owner/Cdashboard/laporan_monitoring_unit/' . $id_perum); ?>" class="btn btn-link btn-sm p-0 text-primary">Lihat semua</a>
                            </h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
