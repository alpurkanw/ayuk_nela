                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="row mb-3">
                        <div class="col d-flex gap-2">
                            <a href="<?= base_url(isset($harga_detail->id_perum) ? 'owner/claporan/lap_hutang_cust_view?id_perumahan=' . $harga_detail->id_perum : 'owner/claporan/lap_hutang_cust_form'); ?>" class="btn btn-secondary">
