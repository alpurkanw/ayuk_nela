...
<head>
    ...
    <link href="<?= base_url("assets/adminsb/vendor/select2/css/select2.min.css"); ?>" rel="stylesheet">
...
<body id="page-top">
                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form id="formDetailHarga" action="<?= base_url('owner/Claporan/lap_out_total_perumah_view'); ?>" method="post">


                                <div class="form-group">
                                    <label for="id_rumah">Pilih Rumah</label>
                                    <select class="form-control select2" id="id_rumah" name="id_rumah" required>
                                        <option value="">Pilih Rumah</option>
                                        <?php if (!empty($list_rumah)) : ?>
                                            <?php foreach ($list_rumah as $rumah) : ?>
                                                <option value="<?= $rumah->id_rumah; ?>">
                                                    <?= $rumah->nama_perum; ?> - <?= $rumah->norumah; ?>
                                                </option>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </select>
    ...
    <script src="<?= base_url("assets/adminsb/vendor/select2/js/select2.min.js"); ?>"></script>
