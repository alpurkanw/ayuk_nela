                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Pembayaran Rumah</h6>
                        </div>
                        <div class="card-body p-4">
                            <form>
                                <div class="form-group">
                                    <label for="nama_perumahan">Nama Perumahan</label>
                                    <select class="form-control" id="nama_perumahan">
                                        <option value="1">Bintang Lacita Residence</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="nama_perumahan">No Rumah</label>
                                    <select class="form-control" id="nama_perumahan">
                                ...
                                <div class="form-group">
                                    <label for="nama_perumahan">Harga-harga </label>
                                    <select class="form-control" id="nama_perumahan">
                                        <option value="1">Booking Fee</option>
                                        <option value="2">Down Payment(DP)</option>
                                        <option value="3">Tambahan Tanah(hook)</option>
                                    </select>
                                </div>

                                <div class="form-group">
                                    <label for="no_rumah">Nominal Pembayaran</label>
                                    <input type="text" class="form-control" id="no_rumah" placeholder="Masukkan Nominal">
                                </div>
