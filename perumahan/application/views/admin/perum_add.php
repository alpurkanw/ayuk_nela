                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">FORM TAMBAH PERUMAHAN</h6>
                        </div>
                        <div class="card-body p-4">
                            <?= $this->session->flashdata('pesan'); ?>
                            <form action="<?= base_url('admin/Cperum/tambah_proses'); ?>" method="post">

                                <div class="form-group">
                                    <label for="nama_perumahan">Nama Perumahan</label>
                                    <input type="text" class="form-control" id="nama_perumahan" name="nama" placeholder="Contoh: Bintang Lacita Residence" required>
                                </div>

                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi</label>
                                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Bisa alamat, jumlah rumah, atau keunggulan lain sperti rumah sakit, sekolah dll"></textarea>
                                </div>

                                <button type="submit" class="btn btn-primary">Simpan Data</button>
                                <a href="<?= base_url('admin/Cperumahan'); ?>" class="btn btn-secondary">Batal</a>
                            </form>
                        </div>
                    </div>
                </div>
