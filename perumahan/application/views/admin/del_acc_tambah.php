                        ...
                        <div class="card-body p-4">
                            <form>
                                <div class="form-group">
                                    <label for="id_acc">ID Akun</label>
                                    <input type="text" class="form-control" id="id_acc" placeholder="Masukkan ID Akun">
                                </div>
                                <div class="form-group">
                                    <label for="no_acc">Nomor Akun</label>
                                    <input type="text" class="form-control" id="no_acc" placeholder="Contoh: 1101, 5101">
                                </div>
                                <div class="form-group">
                                    <label for="desk_acc">Deskripsi Akun</label>
                                    <textarea class="form-control" id="desk_acc" rows="3" placeholder="Contoh: Kas, Pendapatan Penjualan"></textarea>
                                </div>
                                <div class="form-group">
