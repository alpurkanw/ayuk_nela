                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">FORM PENCATATAN PENGELUARAN PER PERUMAHAN(UMUM)</h6>
                        </div>
                        <div class="card-body p-4">
                            <?= $this->session->flashdata('pesan'); ?>
                            <form id="formDetailHarga" action="<?= base_url('admin/Cpengeluaran/trx_out_perum_proses'); ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_perumahan" name="id_perumahan" required>
                                        ...
                                        <?php if (!empty($list_perum)) : ?>
                                            <?php foreach ($list_perum as $perum) :  $perumahan = $perum->id . "|" . $perum->nama;
                                            ?>
