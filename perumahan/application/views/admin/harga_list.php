                ...
                <div class="container-fluid p-2">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">LIST KATEGORI HARGA</h6>
                        </div>
                        <div class="card-body p-2">
                            <div class="row my-2">
                                <div class="col text-left">
                                    <a href="<?= base_url("admin/Charga/add_harga"); ?>" class=" d-none d-sm-inline-block btn btn-sm btn-primary  shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah kategori</a>
                                </div>
                            </div>
