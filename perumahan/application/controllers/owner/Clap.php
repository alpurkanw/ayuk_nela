 ...
 */
class Clap extends MY_Admin_Controller

{
    ...
    public function lap_status_rumah_param()
    {
        ...
        // return;
        $data = "";
        $this->load->view('admin/lap_status_rumah_param', $data);
    }

    public function lap_status_rumah_view()
    {
        // $data['account_list'] = $this->M_account->getAllAccounts();
        // $data['title'] = 'Manajemen Akun Keuangan';
        // echo "tes";
        // return;
        $data = "";
        $this->load->view('admin/lap_status_rumah_view', $data);
    }
    ...
    public function tambah()
    {
        ...
        // return;
        $data = "";
        $this->load->view('admin/acc_tambah', $data);
    }
